...
const handler = async function(m, {conn, text, usedPrefix, command}) {
  try {
    ...
    const caption = `${tradutor.texto8[0]} ${tradutor.texto8[1]}」 ${tradutor.texto8[2]} ${tradutor.texto8[3]} ${name} ${tradutor.texto8[4]} ${age} ${tradutor.texto8[5]} ${tradutor.texto8[6]} ┃ ${sn} ${tradutor.texto8[7]} ${tradutor.texto8[8]} ${tradutor.texto8[9]} ${tradutor.texto8[10]} ${tradutor.texto8[11]}`;
    ...
    m.reply('Ocurrió un error inesperado. Por favor, inténtalo de nuevo.');
  }
};
