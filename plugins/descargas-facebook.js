...
const handler = async (m, { text, conn, args, usedPrefix, command }) => {
  ...
  let res
  try {
    conn.reply(m.chat, `🕒 *Descargando su video de facebook.*`, m, { contextInfo: { externalAdReply: { mediaUrl: null, mediaType: 1, showAdAttribution: true, title: packname, body: dev, previewType: 0, thumbnail: icons, sourceUrl: channel } } })
    await m.react(rwait)
